$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("Include/features/ProAcc_PreConversion/ProgressMonitor_Pm.feature");
formatter.feature({
  "name": "Pre Conversion Progress Monitor functionality",
  "description": "",
  "keyword": "Feature"
});
formatter.scenarioOutline({
  "name": "Pre Conversion Progress Monitoring in Pro Acc Application",
  "description": "",
...
formatter.step({
  "name": "User can add activities by click on Add Activitygoks_Pre",
  "keyword": "And "
});
formatter.match({
...
formatter.step({
  "name": "User has successfully Updated the Progress Monitor Statusgoks_Pre",
  "keyword": "Then "
});
formatter.match({
