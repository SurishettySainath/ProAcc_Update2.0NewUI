$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("Include/features/ProAcc_PostConversion/ProgressMonitor_Consultant.feature");
formatter.feature({
  "name": "Post Conversion Progress Monitor for Consultant",
  "description": "",
  "keyword": "Feature"
});
formatter.scenarioOutline({
  "name": "Post Conversion Monitor functionality for Consultant",
  "description": "",
...
formatter.step({
  "name": "User should select Consultant Customername,Project Name,Consultant Instance Name,phasePost Conversion",
  "keyword": "When "
});
formatter.match({
