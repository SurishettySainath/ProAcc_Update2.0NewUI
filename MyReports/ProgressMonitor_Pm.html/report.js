$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("Include/features/ProAcc_Pm/TaskMonitoring/ProgressMonitor.feature");
formatter.feature({
  "name": "Progress Monitor functionality",
  "description": "",
  "keyword": "Feature"
});
formatter.scenarioOutline({
  "name": "Progress Monitoring in Pro Acc Application",
  "description": "",
...
formatter.step({
  "name": "User can add activities by click on Add ActivityGoks_Ass",
  "keyword": "And "
});
formatter.match({
...
formatter.step({
  "name": "User has successfully Updated the Progress Monitor StatusGoks_Ass",
  "keyword": "Then "
});
formatter.match({
