$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("Include/features/ProAcc_PostConversion/ResourceAllocation_PostCon.feature");
formatter.feature({
  "name": "Post Conversion Resource Allocation functionality",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "User has to select project,Instance from the project dropdownPost Conversion",
  "keyword": "When "
});
formatter.match({
