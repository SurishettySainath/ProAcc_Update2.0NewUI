$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("Include/features/ProAcc_PostConversion/ProgressMonitor_Pm.feature");
formatter.feature({
  "name": "Post Conversion Progress Monitor functionality",
  "description": "",
  "keyword": "Feature"
});
formatter.scenarioOutline({
  "name": "Post Conversion Progress Monitoring in Pro Acc Application",
  "description": "",
...
formatter.step({
  "name": "User can add activities by click on Add Activitygoks_Post",
  "keyword": "And "
});
formatter.match({
...
formatter.step({
  "name": "User has successfully Updated the Progress Monitor Statusgoks_Post",
  "keyword": "Then "
});
formatter.match({
