$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("Include/features/ProAcc_PreConversion/ResourceAllocation_PreCon.feature");
formatter.feature({
  "name": "Pre Conversion Resource Allocation functionality",
  "description": "",
  "keyword": "Feature"
});
...
formatter.step({
  "name": "User has to select project,Instance from the project dropdownPre Conversion",
  "keyword": "When "
});
formatter.match({
